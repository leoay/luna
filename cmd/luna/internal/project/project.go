...
var CmdNew = &cobra.Command{
	...
	Long:  "Create a service project using the repository template. Example: luna new helloworld",
	Run:   run,
}
...
func init() {
	if repoURL = os.Getenv("LUNA_LAYOUT_REPO"); repoURL == "" {
		repoURL = "https://github.com/leoay/luna-layout.git"
	}
	timeout = "60s"
